                            ...
                            <Nav variant="pills" className="flex-column">
                                ...
                                <Nav.Item>
                                    <Nav.Link eventKey="Third">
                                        <li>
                                            <a>
                                                <Varification alt="Verification" className="icon-dashboard" /> User Verification
                                            </a>
                                        </li>
                                    </Nav.Link>
                                </Nav.Item>
                                        ...
                                        >
                                            <Tab eventKey="home" title="Add Admin">
                                                <Form>
                                                    ...
                                                    <Row>
                                                        <Form.Group as={Col} controlId="formGridEmail">
                                                            <Form.Label className="text-bottom text-bold">Legel Entity</Form.Label>
                                                            <Form.Control
                                                                type="text"
                                                                className="field-size"
                                                            />
                                                ...
                                                <Form.Group as={Col}>
                                                    <div className="file file--upload send-btn">
                                                        <label for="input-file">
                                                            <PlusCircleFill alt="upload" className="upload-send" />Send to specific user
                                                        </label>
                                                    ...
                                                    <div className="file file--upload send-btn">
                                                        <label for="input-file">
                                                            <CloudUploadFill alt="upload" className="upload-send" />Upload Verification file
                                                        </label>
                                                        <input id="input-file" type="file" />
                                                    </div>
                                                </Form.Group>
