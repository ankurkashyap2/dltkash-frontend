...
import { Form, FormControl, Button, Row, Col, InputGroup, Pagination, Tabs, Tab, Nav } from 'react-bootstrap';
                ...
                <Row>
                    ...
                    <Nav variant="pills" className="flex-column">
                        ...
                        <Nav.Link eventKey="first">
                            <li>
                            <a class='active'> <img src={dashboard} alt='dashboard' className='icon-dashboard' /> Dashboard</a>
                        </li></Nav.Link>
                        </Nav.Item>
                        <Nav.Item>
                        <Nav.Link eventKey="second"><li>
                            <a> <img src={User} alt='user' className='icon-dashboard' /> Admin User</a>
                        </li></Nav.Link>
                        </Nav.Item>
                    </Nav>
                        ...
                        <Row>
                            ...
                            <Col sm={2}>
                                <Form.Group controlId="formGridEmail">
                                    ...
                                    <Form.Control type="date" name="datefrom" placeholder='From' className="field-size" />
                                </Form.Group>
                            </Col>
                            <Col sm={2}>
                                <Form.Group controlId="formGridEmail">
                            ...
                            <Col sm={5}>
                                ...
                                <img src={filter} alt='filter' className='icon-dashboard btn-position mt-4' />
                            </Col>
                        </Row>
                    </div>
                    <div class="table-responsive">
                        <table class="table table-hover dashboard-table" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    ...
                                    <th class="col-md-1">Mobile Status <img src={up} className='up-arrow' /><img src={down} className='down-arrow' /></th>
                                    <th class="col-md-1">Email Status <img src={up} className='up-arrow' /><img src={down} className='down-arrow' /></th>
                                    <th class="col-md-1">PAN Status <img src={up} className='up-arrow' /><img src={down} className='down-arrow' /></th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                                    ...
                                    <td className='verfied-pill'><span>Verified</span></td>
                                    <td className='not-verfied-pill'><span>Not Verified</span></td>
                                    <td className='verfied-pill'><span>Verified</span></td>
                                </tr>
                                <tr>
                                    <td>2.</td>
